...
const MentionInput = ({
  ...
  //Generate suggestions for the mention input based on the upstream nodes and their outputs, formats the suggestions in a way that can be easily inserted into the input value when selected, also ensures that the suggestions are updated whenever the nodeId or the workflow context changes
