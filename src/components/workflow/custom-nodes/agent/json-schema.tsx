  ...
  const updateSchema = (newFields: any[]) => {
    ...
    newFields.forEach((f) => {
      ...
      const field: any = {
        ...
        //? commenting this out becuase it causes an issue where the streamText ommits the field in the output if the value is empty string, 0 or false. We can revisit this later if needed
