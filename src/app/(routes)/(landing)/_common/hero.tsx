    ...
    >
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <span className="block mt-2 bg-clip-text text-transparent bg-linear-to-r from-indigo-600 via-violet-600 to-indigo-600 dark:from-indigo-400 dark:via-violet-400 dark:to-indigo-400 animate-gradient-x pb-2">
            Visual Workflows
          </span>
        </h1>
